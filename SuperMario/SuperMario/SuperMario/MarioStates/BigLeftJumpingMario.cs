...
{
    class BigLeftJumpingMario : IPlayableObjectState
    {
        ...
        public BigLeftJumpingMario(IPlayableObject playableObject)
        {
            ...
            sprite = AnimatedSpriteFactory.Instance.BuildBigLeftJumpingMarioSprite();
            this.playableObject.CollisionRectangle = sprite.SpriteDestinationRectangle;
        }

        public void Update(GameTime gameTime)
        {
            // big left jumping mario only has one animation frame and doesn't need to call AdvanceFrame()
