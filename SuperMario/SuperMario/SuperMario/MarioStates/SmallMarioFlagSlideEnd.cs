...
{
    public class SmallMarioFlagSlideEnd : IPlayableObjectState
    {
        private AnimatedSprite sprite;
        private IPlayableObject playableObject;

        public SmallMarioFlagSlideEnd(IPlayableObject playableObject)
        {
            this.playableObject = playableObject;
            this.playableObject.StarPower = false;
            sprite = AnimatedSpriteFactory.Instance.BuildSmallFlagSlideEndMarioSprite();
