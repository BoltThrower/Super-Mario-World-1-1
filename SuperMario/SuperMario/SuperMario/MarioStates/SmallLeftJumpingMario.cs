...
{
    class SmallLeftJumpingMario : IPlayableObjectState
    {
        ...
        public SmallLeftJumpingMario(IPlayableObject playableObject)
        {
            ...
            sprite = AnimatedSpriteFactory.Instance.BuildSmallLeftJumpingMarioSprite();
            this.playableObject.CollisionRectangle = sprite.SpriteDestinationRectangle;
        }

        public void Update(GameTime gameTime)
        {
            // small left jumping mario only has one animation frame and doesn't need to call AdvanceFrame()
        ...
        {
            playableObject.Acceleration = new Vector2(-GameValues.MarioHorizontalAcceleration / GameValues.MarioStateAccelerationOffset, Mario.Instance.Acceleration.Y);
        }
