...
{
    class BigMarioFlagSlide : IPlayableObjectState
    {
        private AnimatedSprite sprite;
        private IPlayableObject playableObject;

        public BigMarioFlagSlide(IPlayableObject playableObject)
        {
            this.playableObject = playableObject;
            this.playableObject.StarPower = false;
            sprite = AnimatedSpriteFactory.Instance.BuildBigFlagSlideMarioSprite();
        }
