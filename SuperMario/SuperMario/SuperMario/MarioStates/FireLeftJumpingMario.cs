...
{
    class FireLeftJumpingMario : IPlayableObjectState
    {
        ...
        public FireLeftJumpingMario(IPlayableObject playableObject)
        {
            ...
            sprite = AnimatedSpriteFactory.Instance.BuildFireLeftJumpingMarioSprite();
            this.playableObject.CollisionRectangle = sprite.SpriteDestinationRectangle;
        }

        public void Update(GameTime gameTime)
        {
            // fire left jumping mario only has one animation frame and doesn't need to call AdvanceFrame()
