...
{
    public class SmallLeftWalkingMarioYoshi : IPlayableObjectState
    {
        private AnimatedSprite sprite;

        private IPlayableObject playableObject;

        public SmallLeftWalkingMarioYoshi(IPlayableObject playableObject)
        {
            this.playableObject = playableObject;
            sprite = AnimatedSpriteFactory.Instance.BuildSmallLeftWalkingMarioYoshiSprite(playableObject.Position);
