...
{
    public class BigLeftJumpingMarioYoshi : IPlayableObjectState
    {
        ...
        public BigLeftJumpingMarioYoshi(IPlayableObject playableObject)
        {
            ...
            sprite = AnimatedSpriteFactory.Instance.BuildBigLeftJumpingMarioYoshiSprite(playableObject.Position);
