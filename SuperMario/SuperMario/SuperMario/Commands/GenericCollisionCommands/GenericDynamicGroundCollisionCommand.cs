...
{
    class GenericDynamicGroundCollisionCommand : ICommand
    {
        private IDynamicObject dynamicObject1;
        private IDynamicObject dynamicObject2;

        public GenericDynamicGroundCollisionCommand(IDynamicObject dynamicObject1, IDynamicObject dynamicObject2)
        {
